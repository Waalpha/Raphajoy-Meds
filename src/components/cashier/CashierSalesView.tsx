            ...
            <div key={sale.id} className="bg-white rounded-2xl p-5 border border-gray-200 shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <span className="font-mono text-xs font-bold bg-emerald-50 text-emerald-800 px-2.5 py-1 rounded-md border border-emerald-200">
              ...
              <div className="text-right border-t md:border-t-0 pt-3 md:pt-0 border-gray-100 flex md:flex-col justify-between items-center md:items-end">
                ...
                <span className="text-xl font-black text-emerald-700">{formatCurrency(sale.totalAmount, currency)}</span>
              </div>
            </div>
          ))}
        </div>
